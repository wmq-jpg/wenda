...
public interface MessageDAO {
       ...
       // @Select({"select " ,INSERT_FIELDS ,"count(id) as id from(select * from",TABLE_NAME,"where from_id=#{userId} or to_id=#{userId} order by id desc) tt group by conversation_id" +
